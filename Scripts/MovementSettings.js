...
{
    const Panel_Movement = Content.getComponent("Panel_Movement");
    const Button_MoveDisplay = Content.getComponent("Button_MoveDisplay");
    const Button_MovementSettingsClose = Content.getComponent("Button_MovementSettingsClose");

    const Panel_MovementXYPad = Content.getComponent("Panel_MovementXYPad");
    const Slider_MovementYInvisible = Content.getComponent("Slider_MovementYInvisible");
    const Slider_MovementXInvisible = Content.getComponent("Slider_MovementXInvisible");

    const Label_MovementEnvAAttackValue = Content.getComponent("Label_MovementEnvAAttackValue");
    const Label_MovementEnvADecayValue = Content.getComponent("Label_MovementEnvADecayValue");
    const Label_MovementEnvASustainValue = Content.getComponent("Label_MovementEnvASustainValue");
    const Label_MovementEnvAReleaseValue = Content.getComponent("Label_MovementEnvAReleaseValue");
    const Label_MovementEnvBAttackValue = Content.getComponent("Label_MovementEnvBAttackValue");
    const Label_MovementEnvBDecayValue = Content.getComponent("Label_MovementEnvBDecayValue");
    const Label_MovementEnvBSustainValue = Content.getComponent("Label_MovementEnvBSustainValue");
    const Label_MovementEnvBReleaseValue = Content.getComponent("Label_MovementEnvBReleaseValue");

    const AHDSR_Macro5 = Synth.getModulator("AHDSR_Macro5");
    const AHDSR_Macro6 = Synth.getModulator("AHDSR_Macro6");

    const Label_PanelXYTooltipX = Content.getComponent("Label_PanelXYTooltipX");
    const Label_PanelXYTooltipY = Content.getComponent("Label_PanelXYTooltipY");

    const Label_MovementEnvelopeTitle = Content.getComponent("Label_MovementEnvelopeTitle");
    const Label_MovementTitle = Content.getComponent("Label_MovementTitle");
    const Label_MovementChaosTitle = Content.getComponent("Label_MovementChaosTitle");

    //Advanced Connections

    const Button_MovementSettings = Content.getComponent("Button_MovementSettings");
    const Panel_MovementSettings = Content.getComponent("Panel_MovementSettings");
