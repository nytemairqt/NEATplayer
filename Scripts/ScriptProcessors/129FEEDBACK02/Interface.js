...
//Testing safety callback for arp.

Arpeggiator1.setAttribute(Arpeggiator1.BypassButton, 1);
Arpeggiator1.setAttribute(Arpeggiator1.ResetButton, 1);function onNoteOn()
{
    local e = Message.getNoteNumber();
    local v = Message.getVelocity();
    //Console.print("Note: " + Engine.getMidiNoteName(e));
