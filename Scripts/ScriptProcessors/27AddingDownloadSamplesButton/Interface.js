...
var labeltest = expHandler.getCurrentExpansion();

Label1.set("text", labeltest.getProperties().Name);               

/* EXPANSION NOTES:

After much frustration, it turns out:

1. Copy the EXPANSION FOLDER SUBDIRECTORY to APPDATA/Your Company/Your Product/Expansions
2. Copy the SAMPLES/SAMPLEMAP/MONOLITH to designated Samples Folder.

For whatever reason, expHandler.installExpansionFromPackage() isn't doing the above properly.

Might have to do it manually... who gives a shit about copy protection.
