...
inline function onButton_OpenExpansionsControl(component, value)
{
    if (value)
    {
	    ...
	    for (i=0; i<ComboBoxUpArrows.length; i++)
        {
            ComboBoxUpArrows[i].setPosition(73+190,ComboBoxUpArrows[i].getGlobalPositionY(), ComboBoxUpArrows[i].getWidth(), ComboBoxUpArrows[i].getHeight());
            ComboBoxDownArrows[i].setPosition(73+190,ComboBoxDownArrows[i].getGlobalPositionY(), ComboBoxDownArrows[i].getWidth(), ComboBoxDownArrows[i].getHeight());
        }      
    }
	else
    {
	    ...
	    for (i=0; i<ComboBoxUpArrows.length; i++)
        {
            ComboBoxUpArrows[i].setPosition(73,ComboBoxUpArrows[i].getGlobalPositionY(), ComboBoxUpArrows[i].getWidth(), ComboBoxUpArrows[i].getHeight());
            ComboBoxDownArrows[i].setPosition(73,ComboBoxDownArrows[i].getGlobalPositionY(), ComboBoxDownArrows[i].getWidth(), ComboBoxDownArrows[i].getHeight());
        }	    
    }
};
