...
const var SamplerRR3 = Synth.getChildSynth("SamplerRR3");
const var Sampler_NoRR = Synth.getChildSynth("Sampler_NoRR");
const var Sampler_NoRR2 = Synth.getChildSynth("Sampler_NoRR2");
const var Sampler_NoRR3 = Synth.getChildSynth("Sampler_NoRR3");
const var Sampler_Loops = Synth.getChildSynth("Sampler_Loops");
const var Sampler_Loops2 = Synth.getChildSynth("Sampler_Loops2");
const var Sampler_Loops3 = Synth.getChildSynth("Sampler_Loops3");
const var Sampler_Other = Synth.getChildSynth("Sampler_Other");

const var samplers = ["SamplerRR", "SamplerRR2", "SamplerRR3", "Sampler_NoRR", "Sampler_NoRR2", "Sampler_NoRR3", "Sampler_Loops", "Sampler_Loops2", "Sampler_Loops3", "Sampler_Other"];
...
const var Sampler_NoRR3Gain = Synth.getEffect("Sampler_NoRR3Gain");
...
const var SamplerRR3_MicVolume = Synth.getEffect("SamplerRR3_MicVolume");
...
const var Sampler_NoRR3MicVolume = Synth.getEffect("Sampler_NoRR3MicVolume");
...
const var Sampler_Loops3Gain = Synth.getEffect("Sampler_Loops3Gain");
...
const var Sampler_LoopsPitchMod3 = Synth.getModulator("Sampler_LoopsPitchMod3");
