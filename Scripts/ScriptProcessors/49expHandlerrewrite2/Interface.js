...
currentExpansion = expHandler.getCurrentExpansion().getProperties.Name;
//currentExpansion = currentExpansion.getProperties().Name;
...
function expCallback()
{
    ...
    currentExpansion = currentExpansion.Name;
    */
    //currentExpansion = Cloudburst.getProperties().Name;
