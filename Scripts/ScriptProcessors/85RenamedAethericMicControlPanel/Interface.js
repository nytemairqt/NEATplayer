...
const var Panel_AethericMicControl = Content.getComponent("Panel_AethericMicControl");
const var Slider_AethericGainMic1 = Content.getComponent("Slider_AethericGainMic1");
const var Slider_AethericGainMic2 = Content.getComponent("Slider_AethericGainMic2");
const var Label_AethericMic1Value = Content.getComponent("Label_AethericMic1Value");
const var Label_AethericMic2Value = Content.getComponent("Label_AethericMic2Value");

inline function onSlider_AethericGainMic1Control(component, value)
{
	Sampler_NoRRMicVolume.setAttribute(Sampler_NoRRMicVolume.Gain, value);
	Label_AethericMic1Value.set("text", Math.round(value) + "dB");
};

Content.getComponent("Slider_AethericGainMic1").setControlCallback(onSlider_AethericGainMic1Control);

inline function onSlider_AethericGainMic2Control(component, value)
{
    Sampler_NoRR2MicVolume.setAttribute(Sampler_NoRR2MicVolume.Gain, value);
	Label_AethericMic2Value.set("text", Math.round(value) + "dB");
};

Content.getComponent("Slider_AethericGainMic2").setControlCallback(onSlider_AethericGainMic2Control);
