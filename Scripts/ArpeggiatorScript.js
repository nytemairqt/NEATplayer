...
namespace ArpeggiatorScript
{
    ...
    const Button_ArpDisplay = Content.getComponent("Button_ArpDisplay");

    const Button_ArpModeUpArrow = Content.getComponent("Button_ArpModeUpArrow");
    const Button_ArpModeDownArrow = Content.getComponent("Button_ArpModeDownArrow");

    const Arp_ModeComboBox = Content.getComponent("Arp_ModeComboBox");
    ...
    const Arpeggiator1 = Synth.getMidiProcessor("Arpeggiator1");
    const Button_ArpBypass = Content.getComponent("Button_ArpBypass");
    const Button_ArpSustain = Content.getComponent("Button_ArpSustain");

    const Slider_ArpSteps = Content.getComponent("Slider_ArpSteps");
    const Slider_ArpSpeed = Content.getComponent("Slider_ArpSpeed");
    const Slider_ArpOctave = Content.getComponent("Slider_ArpOctave");
    const Slider_ArpSwing = Content.getComponent("Slider_ArpSwing");

    const Label_ArpSwingValue = Content.getComponent("Label_ArpSwingValue");
    const Label_ArpOctaveValue = Content.getComponent("Label_ArpOctaveValue");
    const Label_ArpSpeedValue = Content.getComponent("Label_ArpSpeedValue");
    const Label_ArpStepsValue = Content.getComponent("Label_ArpStepsValue");

    const arpTimes = ["1/1", "1/2D", "1/2", "1/2T", "1/4D", "1/4", "1/4T", "1/8D", "1/8", "1/8T", "1/16D", "1/16", "1/16T", "1/32D", "1/32", "1/32T", "1/64D", "1/64", "1/64T"];
    const SliderPack_ArpVelocity = Content.getComponent("SliderPack_ArpVelocity");
    const SliderPack_ArpNotes = Content.getComponent("SliderPack_ArpNotes");
    const SliderPack_ArpLength = Content.getComponent("SliderPack_ArpLength");

    const Button_ArpNotesReset = Content.getComponent("Button_ArpNotesReset");
    const Button_ArpVelocityReset = Content.getComponent("Button_ArpVelocityReset");
    const Button_ArpLengthReset = Content.getComponent("Button_ArpLengthReset");

    const Button_ArpNotesMinor = Content.getComponent("Button_ArpNotesMinor");
    const Button_ArpNotesMajor = Content.getComponent("Button_ArpNotesMajor");

    const Button_ArpNotesInvert = Content.getComponent("Button_ArpNotesInvert");

    const Label_Arp = Content.getComponent("Label_Arp");
