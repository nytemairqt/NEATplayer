namespace Randomize 
{
    const Button_OpenRandomizePanel = Content.getComponent("Button_OpenRandomizePanel");

    const Panel_RandomizeContainer = Content.getComponent("Panel_RandomizeContainer");
    const Button_CloseRandomizationPanel = Content.getComponent("Button_CloseRandomizationPanel");

    const randomizationControls = [ArpeggiatorScript.SliderPack_ArpNotes, 
                                   ArpeggiatorScript.SliderPack_ArpVelocity, 
                                   ArpeggiatorScript.SliderPack_ArpLength,
                                   ArpeggiatorScript.Slider_ArpSteps,
                                   ArpeggiatorScript.Slider_ArpSpeed,
                                   ArpeggiatorScript.Slider_ArpOctave,
                                   ArpeggiatorScript.Slider_ArpSwing,
    ...
    const randomizationButtonsArp = [Content.getComponent("Button_RandomizeArpNotes"),
    ...
    const randomizationButtonsADSR =  [
    ...
    const randomizationButtonsSampler = [Content.getComponent("Button_RandomizeSamplerAAttack"),
                                        Content.getComponent("Button_RandomizeSamplerADecay"),
                                        Content.getComponent("Button_RandomizeSamplerASustain"),
                                        Content.getComponent("Button_RandomizeSamplerARelease"),
                                        Content.getComponent("Button_RandomizeSamplerBAttack"),
    ...
    const randomizationButtonsFX = [Content.getComponent("Button_RandomizeFXFilterFreq"),
    ...
    const randomizationButtonsFXBypass = [Content.getComponent("Button_RandomizeFXFilterBypass"),
    ...
    const randomizationButtonsSamplerExtras = [Content.getComponent("Button_RandomizeSamplerASampleStart"),
                                               Content.getComponent("Button_RandomizeSamplerAPitchCoarse"),
                                               Content.getComponent("Button_RandomizeSamplerAPitchFine"),
                                               Content.getComponent("Button_RandomizeSamplerAPan"),
                                               Content.getComponent("Button_RandomizeSamplerAGain"),
    ...
    const randomizationButtonsComboBoxes = [Content.getComponent("Button_RandomizeSamplerAComboBox"),
                                            Content.getComponent("Button_RandomizeSamplerBComboBox"),
                                            Content.getComponent("Button_RandomizeSamplerCComboBox")];
    ...
    inline function randomRESET()
    {
        ...
        ArpeggiatorScript.Button_ArpNotesReset.setValue(1);
        ArpeggiatorScript.Button_ArpNotesReset.changed();
        ArpeggiatorScript.Button_ArpVelocityReset.setValue(1);
        ArpeggiatorScript.Button_ArpVelocityReset.changed();
        ArpeggiatorScript.Button_ArpLengthReset.setValue(1);
        ArpeggiatorScript.Button_ArpLengthReset.changed();
